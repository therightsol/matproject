        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-7 text">
                    <h1><strong class="clr">Marriage Online..</strong>Search Your Better half</h1>
                    ...
                    <div class="form-bottom">
                        <form role="form" action="" method="post" class="registration-form">
                            ...
                            <div class="form-group">
                                ...
                                <select name='LookingFor' class="formsmall">
                            ...
                            <div>
                                <label>    Age :</label>
                                <select name='MinAge' class="formsmall1">
                            ...
                            <div>
                                <label>Cast  : </label>	<select name="Cast" class="searchincludecountry" onchange="change_cast(this.value)">
                            ...
                            <div>
                                <label>Country : </label>	<select name='Country' class="searchincludecountry">
                                    <option value="0.0">Any</option>
                            ...
                            <input type="checkbox" name="with_photo" value="with"  style="margin-top:7px;"/> <span>With Photo</span>
